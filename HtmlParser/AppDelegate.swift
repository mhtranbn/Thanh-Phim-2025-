...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        navigationController.navigationBar.titleTextAttributes = [NSFontAttributeName : (UIFont(name: "HelveticaNeue", size: 10))!]
        var navigationBarAppearace = UINavigationBar.appearance()
        navigationBarAppearace.titleTextAttributes = [NSForegroundColorAttributeName:UIColor.whiteColor()]
        let movieSingleton  = MovieSingleton.sharedInstance
        movieSingleton.currentMovieType = "http://mmovie.hdviet.com/hoat-hinh.x11.p"
        ...
        splashPreferences.splashTemplateAppName = "Thánh Phim";
